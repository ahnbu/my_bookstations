...
### 👤 개인 서재 관리
- **🪟 로그인 전 예시 서재**: 비로그인 방문자에게 도서 20권을 보여주고 검색·정렬·태그 필터·좋아요 필터·뷰 전환을 직접 조작해볼 수 있게 함. 재고가 많은 책부터 아예 없는 책까지 섞어 실제 서재에 가깝게 구성 (정적 스냅샷 `data/demoLibrary.json`, 읽기 전용 `components/DemoLibrary.tsx`)
